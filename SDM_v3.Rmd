...
current <- ggplot() +
  ...
  #geom_sf(data = world) +
  theme_bw() +
  scale_color_viridis_c(breaks = seq(0, 1, 0.25),
                        limits = c(0, 1)) +
...
world_map <-
  ...
  geom_sf(data = world,
          fill = "gray80") +
  geom_rect(aes(xmin = -80.63, xmax = -98.86,
                ymin = 14.37, ymax = 31.14),
            color = "black",
            linewidth = 1,
            fill = NA) +
  coord_sf(xlim = c(-60, -100),
           ylim = c(10, 35)) +
  theme_bw() +
...
patchwork time!
```{r}
current + sdm2_50 + sdm4_50+ world_map + sdm2_90 + sdm4_90 + plot_layout(ncol = 3, guides = 'collect', widths = 1) +
